 ...
 */
#ifndef _ISP_REG_V0000_H_
#define _ISP_REG_V0000_H_
...
**                               Micro Define                                **
**----------------------------------------------------------------------------*/
#define ISP_BASE_ADDR             0x22000000
// Fetch
...
#define ISP_WAVE_THRD             (ISP_BASE_ADDR+0x0618)
...
#define ISP_COMMON_MEM_SWITCH     (ISP_BASE_ADDR+0x2020)
...
union _isp_wave_thrd_tag {
    struct _isp_wave_thrd_map {
        volatile unsigned int r_thr         :10;
        volatile unsigned int g_thr         :10;
        volatile unsigned int b_thr         :10;
        volatile unsigned int reserved      :2;
...
union _isp_afm_win_range0_tag {
    struct _isp_afm_win_range0_map {
        volatile unsigned int win0_start_x  :10;
        volatile unsigned int win0_start_y  :10;
        volatile unsigned int reserved      :12;
    }mBits ;
    volatile unsigned int dwValue ;
};
...
union _isp_afm_win_range1_tag {
    struct _isp_afm_win_range1_map {
        volatile unsigned int win0_end_x    :10;
        volatile unsigned int win0_end_y    :10;
        volatile unsigned int reserved      :12;
    }mBits ;
    volatile unsigned int dwValue ;
};
...
union _isp_afm_win_range2_tag {
    struct _isp_afm_win_range2_map {
        volatile unsigned int win1_start_x  :10;
        volatile unsigned int win1_start_y  :10;
        volatile unsigned int reserved      :12;
    }mBits ;
    volatile unsigned int dwValue ;
};
...
union _isp_afm_win_range3_tag {
    struct _isp_afm_win_range3_map {
        volatile unsigned int win1_end_x    :10;
        volatile unsigned int win1_end_y    :10;
        volatile unsigned int reserved      :12;
    }mBits ;
    volatile unsigned int dwValue ;
};
...
union _isp_afm_win_range4_tag {
    struct _isp_afm_win_range4_map {
        volatile unsigned int win2_start_x  :10;
        volatile unsigned int win2_start_y  :10;
        volatile unsigned int reserved      :12;
    }mBits ;
    volatile unsigned int dwValue ;
};
...
union _isp_afm_win_range5_tag {
    struct _isp_afm_win_range5_map {
        volatile unsigned int win2_end_x    :10;
        volatile unsigned int win2_end_y    :10;
        volatile unsigned int reserved      :12;
    }mBits ;
    volatile unsigned int dwValue ;
};
...
union _isp_afm_win_range6_tag {
    struct _isp_afm_win_range6_map {
        volatile unsigned int win3_start_x  :10;
        volatile unsigned int win3_start_y  :10;
        volatile unsigned int reserved      :12;
    }mBits ;
    volatile unsigned int dwValue ;
};
...
union _isp_afm_win_range7_tag {
    struct _isp_afm_win_range7_map {
        volatile unsigned int win3_end_x    :10;
        volatile unsigned int win3_end_y    :10;
        volatile unsigned int reserved      :12;
    }mBits ;
    volatile unsigned int dwValue ;
};
...
union _isp_afm_win_range8_tag {
    struct _isp_afm_win_range8_map {
        volatile unsigned int win4_start_x  :10;
        volatile unsigned int win4_start_y  :10;
        volatile unsigned int reserved      :12;
    }mBits ;
    volatile unsigned int dwValue ;
};
...
union _isp_afm_win_range9_tag {
    struct _isp_afm_win_range9_map {
        volatile unsigned int win4_end_x    :10;
        volatile unsigned int win4_end_y    :10;
        volatile unsigned int reserved      :12;
    }mBits ;
    volatile unsigned int dwValue ;
};
...
union _isp_afm_win_range10_tag {
    struct _isp_afm_win_range10_map {
        volatile unsigned int win5_start_x  :10;
        volatile unsigned int win5_start_y  :10;
        volatile unsigned int reserved      :12;
    }mBits ;
    volatile unsigned int dwValue ;
};
...
union _isp_afm_win_range11_tag {
    struct _isp_afm_win_range11_map {
        volatile unsigned int win5_end_x    :10;
        volatile unsigned int win5_end_y    :10;
        volatile unsigned int reserved      :12;
    }mBits ;
    volatile unsigned int dwValue ;
};
...
union _isp_afm_win_range12_tag {
    struct _isp_afm_win_range12_map {
        volatile unsigned int win6_start_x  :10;
        volatile unsigned int win6_start_y  :10;
        volatile unsigned int reserved      :12;
    }mBits ;
    volatile unsigned int dwValue ;
};
...
union _isp_afm_win_range13_tag {
    struct _isp_afm_win_range13_map {
        volatile unsigned int win6_end_x    :10;
        volatile unsigned int win6_end_y    :10;
        volatile unsigned int reserved      :12;
    }mBits ;
    volatile unsigned int dwValue ;
};
...
union _isp_afm_win_range14_tag {
    struct _isp_afm_win_range14_map {
        volatile unsigned int win7_start_x  :10;
        volatile unsigned int win7_start_y  :10;
        volatile unsigned int reserved      :12;
    }mBits ;
    volatile unsigned int dwValue ;
};
...
union _isp_afm_win_range15_tag {
    struct _isp_afm_win_range15_map {
        volatile unsigned int win7_end_x    :10;
        volatile unsigned int win7_end_y    :10;
        volatile unsigned int reserved      :12;
    }mBits ;
    volatile unsigned int dwValue ;
};
...
union _isp_afm_win_range16_tag {
    struct _isp_afm_win_range16_map {
        volatile unsigned int win8_start_x  :10;
        volatile unsigned int win8_start_y  :10;
        volatile unsigned int reserved      :12;
    }mBits ;
    volatile unsigned int dwValue ;
};
...
union _isp_afm_win_range17_tag {
    struct _isp_afm_win_range17_map {
        volatile unsigned int win8_end_x    :10;
        volatile unsigned int win8_end_y    :10;
        volatile unsigned int reserved      :12;
    }mBits ;
    volatile unsigned int dwValue ;
};
...
union _isp_com_mem_switch_tag {
    struct _isp_com_mem_switch_map {
