...
/**
 * Applications wishing use the FmReceiver must implement the 
...
public interface IFmReceiverEventHandler {
	 ...
	 *        hopping is enabled.
	 */
	public void onRdsModeEvent(int rdsMode,
			int alternateFreqHopEnabled);
	 ...
	 */
	public void onRdsDataEvent(int rdsDataType,
