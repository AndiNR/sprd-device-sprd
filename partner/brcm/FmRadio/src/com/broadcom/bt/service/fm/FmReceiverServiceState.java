...
{
     static final String FM_RECEIVER_PERM = ""; //FIXME//android.Manifest.permission.ACCESS_FM_RECEIVER;
    ...
    static final int OPERATION_ENABLE = 4;  // When a enable command requested.
    static final int OPERATION_DISABLE = 5; // When a disable command requested.
    static final int OPERATION_SEARCH = 10; // When a search command requested.
    static final int OPERATION_NFL = 99; // When NFL is executed, this takes too much time.
    static final int OPERATION_GENERIC = 100;
    
    /* Timeout for various operations to avoid locking state machine. */
    static final int OPERATION_TIMEOUT_STARTUP = 10000; // 5 sec startup
    static final int OPERATION_TIMEOUT_SHUTDOWN = 10000; // 5 sec shutdown
    ...
    static final int FUNC_BITMASK = FUNC_REGION_BITMASK | FUNC_RDS_BITMASK | FUNC_SOFTMUTE_BITMASK;
    ...
    static final int SCAN_MODE_BITMASK = 0x00000082;
    ...
    static int mFuncMask = FmReceiver.FUNC_REGION_DEFAULT|FmReceiver.FUNC_RDS|FmReceiver.FUNC_AF|FmReceiver.FUNC_SOFTMUTE;
    static int mFreq = 0;    
    ...
    static int mAudioMode = FmReceiver.AUDIO_MODE_AUTO;    
    static int mAudioPath = FmReceiver.AUDIO_PATH_SPEAKER;    
    static int mWorldRegion = FmReceiver.FUNC_REGION_DEFAULT;
    static int mStepSize = FmReceiver.FREQ_STEP_DEFAULT;
    static boolean mLiveAudioQuality = FmReceiver.LIVE_AUDIO_QUALITY_DEFAULT;
    static int mEstimatedNoiseFloorLevel = FmReceiver.NFL_DEFAULT;
    static int mSignalPollInterval = FmReceiver.SIGNAL_POLL_INTERVAL_DEFAULT;
    static int mDeemphasisTime = FmReceiver.DEEMPHASIS_TIME_DEFAULT;
